...
class App extends React.Component {
  ...
  handleNavClick() {
    this.setState({ currentCategory: this.state.currentCategory === "TV" ? "Movie" : "TV" })
  }
